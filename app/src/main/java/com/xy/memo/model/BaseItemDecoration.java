...
/**
 * 自定义recyclerview间隔
 * @author xy 2016-10-16.
 */

public class BaseItemDecoration extends RecyclerView.ItemDecoration {
    private Context mContext;
    static int dividerColor = R.color.bg_grey;//分割线的颜色
    float mDividerSize;
    ...
    public BaseItemDecoration(Context ctx, int dividerSize) {
        this(ctx, dividerSize, dividerColor);
    }

    public BaseItemDecoration(Context ctx, Drawable drawable) {
        this(drawable, 1);
    }

    public BaseItemDecoration(Context ctx, int dividerSize, int dividerColor) {
        this.mContext = ctx;
        mDividerSize = dividerSize;
        mDividerDrawableV = ContextCompat.getDrawable(ctx, dividerColor);
        mDividerDrawableH = mDividerDrawableV;
    }

    public BaseItemDecoration(Drawable drawable, int dividerSize) {
        mDividerSize = dividerSize;
    ...
    public static void setDividerColor(int dividerColor) {
        BaseItemDecoration.dividerColor = dividerColor;
    }
